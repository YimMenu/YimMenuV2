...
{
	class CayoPericoSkip : public Command
	{
	public:
		CayoPericoSkip(const std::string& name, const std::string& description, const std::string& detailedDescription) :
	...
	public:
		...
		virtual void OnCall() override
		{
			FiberPool::Push([this] {
				...
				ApplyStat("MP0_H4_TARGET_POSIX", 1659643454);
				ApplyStat("MP0_H4_COOLDOWN", 0);
				ApplyStat("MP0_H4_COOLDOWN_HARD", 0);
				ApplyStat("MP0_H4_TARGET_POSIX", 1659429119);
				ApplyStat("MP0_H4_COOLDOWN", 0);
				ApplyStat("MP0_H4_COOLDOWN_HARD", 0);
	...
	static CayoPericoSkip g_cayo_perico_skip{"cayopericoskip", "Cayo Perico Skip", "Skip Cayo Perico"};
}